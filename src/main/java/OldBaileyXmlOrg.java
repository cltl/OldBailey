 ...
 */
public class OldBaileyXmlOrg extends org.xml.sax.helpers.DefaultHandler {
    static String value = "";
    ...
    static public void main(String[] args) {
        ...
        ArrayList<File> xmlFiles = OBHelper.makeFlatFileList(new File(xmlFolder), ".xml");
    ...
    static HashMap<String, ArrayList<File>> makeFileIdentifierMap (ArrayList<File> xmlFiles, ArrayList<File> trigFiles) {
        ...
        for (int x = 0; x < xmlFiles.size(); x++) {
            ...
            OldBaileyXmlOrg oldBaileysXml = new OldBaileyXmlOrg();
            ...
            for (int i = 0; i < trigFiles.size(); i++) {
                ...
                if (trigFile.getName().startsWith(fileIdentifier)) {
                    ...
                    try {
                        ...
                        adaptTriples(dataset, OldBaileyXmlOrg.fileData);
